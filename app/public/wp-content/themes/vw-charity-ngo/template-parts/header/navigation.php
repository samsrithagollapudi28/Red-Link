        ...
        <div class="col-lg-7 col-md-4 col-6">
          <?php 
            ...
            <div class="toggle-nav mobile-menu">
              <button onclick="vw_charity_ngo_menu_open_nav()" class="responsivetoggle"><i class="<?php echo esc_attr(get_theme_mod('vw_charity_ngo_res_menu_open_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','vw-charity-ngo'); ?></span></button>
            </div> 
          <?php } ?>
