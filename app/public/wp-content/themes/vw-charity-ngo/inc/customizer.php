...
function vw_charity_ngo_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('vw_charity_ngo_sticky_header_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_sticky_header_padding',array(
		'label'	=> __('Sticky Header Padding','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
	...
	$wp_customize->add_setting('vw_charity_ngo_contact',array(
		'default'	=> '',
		'sanitize_callback'	=> 'vw_charity_ngo_sanitize_phone_number'
	));	
	...
	$wp_customize->add_setting('vw_charity_ngo_email',array(
		'default'	=> '',
		'sanitize_callback'	=> 'vw_charity_ngo_sanitize_email'
	));	
	...
	$wp_customize->add_setting('vw_charity_ngo_slider_button_text',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_slider_button_text',array(
		'label'	=> __('Add Slider Button Text','vw-charity-ngo'),
		'input_attrs' => array(
	...
	$wp_customize->add_setting( 'vw_charity_ngo_slider_excerpt_number', array(
		'default'              => 30,
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_charity_ngo_sanitize_number_range'
	) );
	...
	//Slider height
	$wp_customize->add_setting('vw_charity_ngo_slider_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_slider_height',array(
		'label'	=> __('Slider Height','vw-charity-ngo'),
		'description'	=> __('Specify the slider height (px).','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '500px', 'vw-charity-ngo' ),
        ),
		'section'=> 'vw_charity_ngo_slidersettings',
		'type'=> 'text'
	));

	$wp_customize->add_setting( 'vw_charity_ngo_slider_speed', array(
		'default'  => 3000,
		'sanitize_callback'	=> 'vw_charity_ngo_sanitize_float'
	) );
	$wp_customize->add_control( 'vw_charity_ngo_slider_speed', array(
		'label' => esc_html__('Slider Transition Speed','vw-charity-ngo'),
		'section' => 'vw_charity_ngo_slidersettings',
		'type'  => 'number',
	) );
	...
	$wp_customize->add_setting( 'vw_charity_ngo_blog_pagination_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_charity_ngo_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Charity_NGO_Toggle_Switch_Custom_Control( $wp_customize, 'vw_charity_ngo_blog_pagination_hide_show',array(
      'label' => esc_html__( 'Show / Hide Blog Pagination','vw-charity-ngo' ),
      'section' => 'vw_charity_ngo_post_settings'
    )));

	$wp_customize->add_setting( 'vw_charity_ngo_blog_pagination_type', array(
        'default'			=> 'blog-page-numbers',
        'sanitize_callback'	=> 'vw_charity_ngo_sanitize_choices'
    ));
    $wp_customize->add_control( 'vw_charity_ngo_blog_pagination_type', array(
        'section' => 'vw_charity_ngo_post_settings',
        'type' => 'select',
        'label' => __( 'Blog Pagination', 'vw-charity-ngo' ),
        'choices'		=> array(
            'blog-page-numbers'  => __( 'Numeric', 'vw-charity-ngo' ),
            'next-prev' => __( 'Older Posts/Newer Posts', 'vw-charity-ngo' ),
    )));
	...
	$wp_customize->add_section( 'vw_charity_ngo_single_blog_settings', array(
		'title' => __( 'Single Post Settings', 'vw-charity-ngo' ),
		'panel' => 'blog_post_parent_panel',
	));

	$wp_customize->add_setting( 'vw_charity_ngo_single_blog_post_navigation_show_hide',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_charity_ngo_switch_sanitization'
	));
    $wp_customize->add_control( new VW_Charity_NGO_Toggle_Switch_Custom_Control( $wp_customize, 'vw_charity_ngo_single_blog_post_navigation_show_hide', array(
		'label' => esc_html__( 'Post Navigation','vw-charity-ngo' ),
		'section' => 'vw_charity_ngo_single_blog_settings'
    )));

	//navigation text
	$wp_customize->add_setting('vw_charity_ngo_single_blog_prev_navigation_text',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_single_blog_prev_navigation_text',array(
		'label'	=> __('Post Navigation Text','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( 'PREVIOUS', 'vw-charity-ngo' ),
        ),
		'section'=> 'vw_charity_ngo_single_blog_settings',
		'type'=> 'text'
	));

	$wp_customize->add_setting('vw_charity_ngo_single_blog_next_navigation_text',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_single_blog_next_navigation_text',array(
		'label'	=> __('Post Navigation Text','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( 'NEXT', 'vw-charity-ngo' ),
        ),
		'section'=> 'vw_charity_ngo_single_blog_settings',
		'type'=> 'text'
	));
	...
	//Social Icon Setting
	$wp_customize->add_section('vw_charity_ngo_social_icon_settings',array(
		'title'	=> __('Social Icons Settings','vw-charity-ngo'),
		'panel' => 'vw_charity_ngo_panel_id',
	));	

	$wp_customize->add_setting('vw_charity_ngo_social_icon_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_social_icon_font_size',array(
		'label'	=> __('Icon Font Size','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
		'section'=> 'vw_charity_ngo_social_icon_settings',
		'type'=> 'text'
	));

	$wp_customize->add_setting('vw_charity_ngo_social_icon_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_social_icon_padding',array(
		'label'	=> __('Icon Padding','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
	...
	$wp_customize->add_setting('vw_charity_ngo_social_icon_width',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_social_icon_width',array(
		'label'	=> __('Icon Width','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
	...
	$wp_customize->add_setting('vw_charity_ngo_social_icon_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_social_icon_height',array(
		'label'	=> __('Icon Height','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
	...
	$wp_customize->add_setting( 'vw_charity_ngo_social_icon_border_radius', array(
		'default'              => '',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_charity_ngo_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_charity_ngo_social_icon_border_radius', array(
		'label'       => esc_html__( 'Icon Border Radius','vw-charity-ngo' ),
		'section'     => 'vw_charity_ngo_social_icon_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
    ...
    $wp_customize->add_setting( 'vw_charity_ngo_resp_scroll_top_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_charity_ngo_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Charity_NGO_Toggle_Switch_Custom_Control( $wp_customize, 'vw_charity_ngo_resp_scroll_top_hide_show',array(
	...
	$wp_customize->add_setting('vw_charity_ngo_scroll_to_top_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_scroll_to_top_font_size',array(
		'label'	=> __('Icon Font Size','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
	...
	$wp_customize->add_setting('vw_charity_ngo_scroll_to_top_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_scroll_to_top_padding',array(
		'label'	=> __('Icon Top Bottom Padding','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
	...
	$wp_customize->add_setting('vw_charity_ngo_scroll_to_top_width',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_scroll_to_top_width',array(
		'label'	=> __('Icon Width','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
	...
	$wp_customize->add_setting('vw_charity_ngo_scroll_to_top_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_scroll_to_top_height',array(
		'label'	=> __('Icon Height','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
	...
	$wp_customize->add_setting( 'vw_charity_ngo_scroll_to_top_border_radius', array(
		'default'              => '',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_charity_ngo_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_charity_ngo_scroll_to_top_border_radius', array(
		'label'       => esc_html__( 'Icon Border Radius','vw-charity-ngo' ),
		'section'     => 'vw_charity_ngo_footer',
		'type'        => 'range',
		'input_attrs' => array(
	...
	$wp_customize->add_section('vw_charity_ngo_woocommerce_section', array(
		'title'    => __('WooCommerce Layout', 'vw-charity-ngo'),
		'priority' => null,
		'panel'    => 'woocommerce',
	));
    ...
    $wp_customize->add_control( new VW_Charity_NGO_Toggle_Switch_Custom_Control( $wp_customize, 'vw_charity_ngo_woocommerce_shop_page_sidebar',array(
		...
		'section' => 'vw_charity_ngo_woocommerce_section'
    )));
    ...
    $wp_customize->add_control( new VW_Charity_NGO_Toggle_Switch_Custom_Control( $wp_customize, 'vw_charity_ngo_woocommerce_single_product_page_sidebar',array(
     ...
     //Products per page
    $wp_customize->add_setting('vw_charity_ngo_products_per_page',array(
		'default'=> '9',
		'sanitize_callback'	=> 'vw_charity_ngo_sanitize_float'
	));
	$wp_customize->add_control('vw_charity_ngo_products_per_page',array(
		'label'	=> __('Products Per Page','vw-charity-ngo'),
		'description' => __('Display on shop page','vw-charity-ngo'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
    ...
    //Products per row
    $wp_customize->add_setting('vw_charity_ngo_products_per_row',array(
		'default'=> '3',
		'sanitize_callback'	=> 'vw_charity_ngo_sanitize_choices'
	));
	$wp_customize->add_control('vw_charity_ngo_products_per_row',array(
		'label'	=> __('Products Per Row','vw-charity-ngo'),
		'description' => __('Display on shop page','vw-charity-ngo'),
		'choices' => array(
            '2' => '2',
			'3' => '3',
	...
	//Products padding
	$wp_customize->add_setting('vw_charity_ngo_products_padding_top_bottom',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_products_padding_top_bottom',array(
		'label'	=> __('Products Padding Top Bottom','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
	...
	$wp_customize->add_setting('vw_charity_ngo_products_padding_left_right',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_charity_ngo_products_padding_left_right',array(
		'label'	=> __('Products Padding Left Right','vw-charity-ngo'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-charity-ngo'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-charity-ngo' ),
        ),
	...
	//Products box shadow
	$wp_customize->add_setting( 'vw_charity_ngo_products_box_shadow', array(
		'default'              => '',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_charity_ngo_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_charity_ngo_products_box_shadow', array(
		'label'       => esc_html__( 'Products Box Shadow','vw-charity-ngo' ),
		'section'     => 'vw_charity_ngo_woocommerce_section',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
    ...
    $wp_customize->add_setting( 'vw_charity_ngo_products_border_radius', array(
		'default'              => '',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_charity_ngo_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_charity_ngo_products_border_radius', array(
		'label'       => esc_html__( 'Products Border Radius','vw-charity-ngo' ),
		'section'     => 'vw_charity_ngo_woocommerce_section',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
