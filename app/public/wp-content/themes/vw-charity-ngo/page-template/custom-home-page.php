...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod('vw_charity_ngo_slider_hide_show') != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'vw_charity_ngo_slider_speed',3000)) ?>"> 
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <?php if( get_theme_mod('vw_charity_ngo_slider_button_text','READ MORE') != ''){ ?>
                    <div class="more-btn">              
                      <a href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html(get_theme_mod('vw_charity_ngo_slider_button_text',__('READ MORE','vw-charity-ngo')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_charity_ngo_slider_button_text',__('READ MORE','vw-charity-ngo')));?></span></a>
                    </div>
                  <?php } ?>
                </div>
              </div>
        ...
        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
          ...
          <span class="screen-reader-text"><?php esc_html_e( 'Previous','vw-charity-ngo' );?></span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
          <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-chevron-right"></i></span>
          <span class="screen-reader-text"><?php esc_html_e( 'Next','vw-charity-ngo' );?></span>
        </a>
      </div>  
